    ...
    <v-window v-model="step">
      <v-window-item :value="1">
        <v-card-text>
          ...
          <p class="mt-3 text-center">با این سرویس می توانید در مراسمات ترحیم پیش رو به نام دلخواه تاج گل قرار دهید . هزینه های دریافتی صرف امور خیر می شوند و هم شما و مرحوم از ثواب آن بهرمند می شوید .</p>
        </v-card-text>
      </v-window-item>
      ...
      <v-window-item :value="2">
        <v-card-text>
          <v-item-group selected-class="bg-primary">
            <v-item v-if="marasemData != null" v-for="item in marasemData" v-slot="{ isSelected, selectedClass, toggle }">
            <v-card class="mb-3" :class="[ selectedClass]"
              dark
              @click="toggle"
            >
              <v-card-text>
...
<p v-if="trafList.length == 0" class="text-center">هیچ نامی وجود ندارد . لطفا از قسمت بالا یک نام اضافه کنید</p>
